...
-- ============================================================
-- ▼ migration_add_app_settings.sql（全般設定・機能ON/OFF）
-- ============================================================
...
-- ============================================================
-- ▼ migration_rename_operator_role.sql（既存DB用・新規DBでは無害）
-- ============================================================
-- ロール改称: 「リーダー」→「オペレーター」
...
-- ============================================================
-- ▼ migration_add_role_permissions.sql（ロール権限マスタ）
-- ============================================================
