...
import type { EmbedResolver } from "./RichBody";
...
export function PublicPage({
  ...
  // ⚠️ ここは「サーバーが通してくれたものを引くだけ」。権限判定はしない。
  //    判定は lib/contentsServer.ts の loadEmbedRefs が済ませている。
          ...
          <div className="space-y-8">
            {(() => {
              ...
              return contents.map((c) => {
                ...
                return <EmbedItem key={c.id} c={c} no={no} resolve={resolveEmbed} />;
              });
            })()}
          </div>
        ) : (
