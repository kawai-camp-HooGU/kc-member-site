...
export function NewsMaint() {
  ...
  const shown = rows.filter((n) => fdr.selected === "unfiled" ? n.folderId == null : n.folderId === fdr.selected);
  ...
  return (
    <div className="space-y-4">
      ...
      {edit && (
        <div className="fixed inset-0 bg-black/40 flex items-end justify-center md:items-center z-50 p-4" onClick={closeEdit}>
